  ...
  function EffectMaterial({ swiper, on, extendParams }) {
    ...
    const setTranslate = () => {
      ...
      for (let i = 0; i < slides.length; i += 1) {
        ...
        const scaleEls = slideEl.querySelectorAll(
        ...
        if (progress <= 0) {
          ...
          if (centeredSlides && slidesPerView > 1) {
            ...
            if (
              ...
              opacity =
                ((scale - largeSlideRatio) / (1 - largeSlideRatio)) ** 4;
              translate =
                swiperTranslate +
                currentSlideSize *
        ...
        if (slidesPerView === 1) {
          ...
          if (
            ...
            const currentProgress =
              Math.ceil(slidesPerView / 2) -
              (slidesPerView - Math.abs(progress));
            translate =
              swiperTranslate -
        ...
        scaleEls.forEach((scaleEl) => {
          ...
          if (
            Number.isNaN(elementScale) ||
            (!elementScale && elementScale !== 0)
          )
            elementScale = 1;
