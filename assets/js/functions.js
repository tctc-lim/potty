...
(function($) {
	...
	var Settings = {
		...
		submenuLight:
				...
				$header.hasClass('submenu-light') == !0 ? !0 :
				!1,
		headerHasDarkClass:

				$header.hasClass('dark') == !0 ? !0 :
				!1,
		...
		mainMenu: function() {
			if ($mainMenu.length > 0) {
				...
				$(window).breakpoints('greaterEqualTo', 'lg', function() {
					...
					if (
						$window.width() - ($menuLastItemUl.width() + $menuLastItem.offset().left) <
						0
					) {
			...
			if ($inspiroSlider.length > 0) {
				...
				function sliderHeight(elem, state) {
					var elem,
						...
						screenRatio =
							elem.hasClass('slider-halfscreen') ? 1 :
							1.2,
				...
				$inspiroSlider.each(function() {
					...
					elem.options = {
						...
						groupCells:
								...
								elem.data('group-cells') == !0 ? !0 :
								!1,
						autoPlay: elem.attr('data-autoplay') || 7000,
						pauseAutoPlayOnHover:

								elem.data('hoverpause') == !0 ? !0 :
								!1,
						adaptiveHeight:

								elem.data('adaptive-height') == !1 ? !1 :
								!1,
						...
						accessibility:
								...
								elem.data('accessibility') == !0 ? !0 :
								!1,
						setGallerySize:

								elem.data('gallery-size') == !1 ? !1 :
								!1,
						resize:

								elem.data('resize') == !1 ? !1 :
								!1,
						cellAlign: elem.attr('data-align') || 'left',
						playWholeVideo:

								elem.attr('data-play-whole-video') == !1 ? !1 :
								!0,
					};
				...
				$carousel.each(function() {
					...
					elem.options = {
						...
						pauseAutoPlayOnHover:
								...
								elem.data('hover-pause') == !1 ? !1 :
								!0,
						asNavFor: elem.attr('data-navigation') || !1,
						lazyLoad:

								elem.data('lazy-load') == !0 ? !0 :
								!1,
						initialIndex: elem.attr('data-initial-index') || 0,
						accessibility:
						...
						adaptiveHeight:
								...
								elem.data('adaptive-height') == !0 ? !0 :
								!1,
						autoWidth:

								elem.data('auto-width') == !0 ? !0 :
								!1,
						setGallerySize:
					...
					elem.options.itemsMd =
						elem.options.itemsMd || Math.min(Number(elem.options.itemsLg), Number(3));
					elem.options.itemsSm =
						elem.options.itemsSm || Math.min(Number(elem.options.itemsMd), Number(2));
					elem.options.itemsXs =
						elem.options.itemsXs || Math.min(Number(elem.options.itemsSm), Number(1));
					...
					if (Number(elem.options.items) !== 1) {
						if (elem.options.autoWidth || carouselCustomHeightStatus) {
							elem
								...
								.css({ 'padding-right': elem.options.margin + 'px' });
						} else {
							itemWidth =
			...
			$accs.length &&
				($accs.each(function() {
					var $item = $(this);
						...
						$item.hasClass(itemActive) ? $item.addClass(itemActive) :
				...
				$('.' + itemTitle).on('click', function(e) {
					var $link = $(this),
						...
						$item.hasClass(itemActive) ? $acc.hasClass(toogleType) ? ($item.removeClass(
							itemActive,
						),
				...
				$ytPlayer.each(function() {
					...
					elem.options = {
						...
						autoPlay:
								...
								elem.data('youtube-autoplay') == !1 ? 0 :
								1,
						mute:

								elem.data('youtube-mute') == !1 ? !1 :
								!0,
						pauseOnScroll:

								elem.data('youtube-pauseOnScroll') == !1 ? !1 :
								!0,
						loop:

								elem.data('youtube-loop') == !1 ? !1 :
								!0,
						...
						controls:
								...
								elem.data('youtube-controls') == !0 ? 1 :
								0,
					};
		...
		instagram: function() {
			...
			if ($widget_instagram.length > 0) {
				...
				$widget_instagram.each(function() {
					...
					elem.append(
						'<div id="instagram-cnt" class="' + instagramGridColumns + '"></div>',
					);
